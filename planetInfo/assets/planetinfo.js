...
$.ajax({
    ...
    var mercFromSun = $("<h6>").text("Planet #: " + "1st");
    ...
    var venusFromSun = $("<h6>").text("Planet #: " + "2nd");
    ...
    var venusDistance = $("<p>").text("Avg Distance from Sun: " + response[1].distance_from_sun + " million km");
    ...
    var earthFromSun = $("<h6>").text("Planet #: " + "3rd");
    ...
    var earthDistance = $("<p>").text("Avg Distance from Sun: " + response[2].distance_from_sun + " million km");
    ...
    var marsFromSun = $("<h6>").text("Planet #: " + "4th");
    ...
    var marsDistance = $("<p>").text("Avg Distance from Sun: " + response[4].distance_from_sun + " million km");
    ...
    var jupFromSun = $("<h6>").text("Planet #: " + "5th");
    ...
    var jupDistance = $("<p>").text("Avg Distance from Sun: " + response[5].distance_from_sun + " million km");
    ...
    var satFromSun = $("<h6>").text("Planet #: " + "6th");
    ...
    var satDistance = $("<p>").text("Avg Distance from Sun: " + response[6].distance_from_sun + " million km");
    ...
    var uraFromSun = $("<h6>").text("Planet #: " + "7th");
    ...
    var uraDistance = $("<p>").text("Avg Distance from Sun: " + response[7].distance_from_sun + " million km");
    ...
    var nepFromSun = $("<h6>").text("Planet #: " + "8th");
    ...
    var nepDistance = $("<p>").text("Avg Distance from Sun: " + response[8].distance_from_sun + " million km");
    ...
    var pluFromSun = $("<h6>").text("Planet #: " + "9th");
    ...
    var pluDistance = $("<p>").text("Avg Distance from Sun: " + response[9].distance_from_sun + " million km");
    ...
    var mooPlanOb = $("<h6>").text("Orbiting Planet: " + "Earth");
    ...
    var mooDistance = $("<p>").text("Avg Distance from Sun: " + response[3].distance_from_sun + " million km");
...
// ***************Create elements for pulling info from moon index***************
var sunGalOb = $("<h6>").text("Orbiting Galaxy: " + "Milky Way");
